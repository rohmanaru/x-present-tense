...
<head>
    <meta charset="utf-8">
    <title>Laporan Presensi {{ $intern->name }}</title>
...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        <table style="width: 100%">
            <tr>
                <td>
                    <img src="{{ asset('assets/img/logo-telkom.png') }}" width="200" height="80" alt="">
                </td>
                <td>
                    <span id="title">
                        Laporan Presensi intern <br>
                        Periode {{ $namaBulan[$bulan] }} {{ $tahun }} <br>
                        Telkom Witel Jambi <br>
                    </span>
                    <span><i>Jl. Seomantri Brodjonegoro no. 54 Jambi</i></span>
                </td>
            </tr>
        </table>
        <table class="tabledataintern">
            <tr>
                <td rowspan="6">
                    @php
                        $path = Storage::url('uploads/intern/'.$intern->foto)
                    @endphp
