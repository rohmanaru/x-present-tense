<x-intern-layout>
    @section('title','Data Izin dan Sakit') @section('header')
    ...
    <div class="row" style="margin-top: 70px">
        <div class="col">
            @php $messageSuccess = Session::get('success'); $messageError =
            Session::get('error'); @endphp @if (Session::get('success'))
    ...
    <div class="fab-button bottom-right" style="margin-bottom: 70px">
        <a href=" {{ route('intern.absensi-form') }}" class="fab">
